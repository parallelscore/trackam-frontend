...
const RiderAcceptPage: React.FC = () => {
    ...
    if (error || !delivery) {
        return (
            <Layout>
                <div className="min-h-screen bg-gradient-to-br from-white via-gray-50/50 to-red-50/30">
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                        <div className="text-center mb-8">
    ...
    if (isDeclined) {
        return (
            <Layout>
                <div className="min-h-screen bg-gradient-to-br from-white via-gray-50/50 to-yellow-50/30">
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                        <div className="text-center mb-8">
